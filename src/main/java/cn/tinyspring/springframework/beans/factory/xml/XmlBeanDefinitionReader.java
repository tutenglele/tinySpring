...
import cn.tinyspring.springframework.context.annotation.ClassPathBeanDefinitionScanner;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    /**
     * 方便的加载和解析xml，XmlBeanDefinitionReader 替换为 dom4j 的方式进行解析处理
     * @param inputStream
    ...
    private void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        for (Element bean : beanList) {
            ...
            String destoryMehtod = bean.attributeValue("destory-method");
            ...
            beanDefinition.setDestroyMethodName(destoryMehtod);
